...
// 書籍のデータ（仮データ）
var books = []Book{
	{BookID: 1, ISBN: "978-4-7741-9763-1", StorageLocation: "裏表紙左下部", LabelType: "brother", LabelSpec: "12mm、ゴールド色、フォント：ImpactURW、サイズ：20", AttachmentLocationSpec: "オフィス", Notes: "〇〇のスタンプは上部に押印する"},
	{BookID: 2, ISBN: "9784295008057", StorageLocation: "裏表紙左下部", LabelType: "brother", LabelSpec: "12mm、ゴールド色、フォント：ImpactURW、サイズ：20", AttachmentLocationSpec: "オフィス", Notes: "〇〇のスタンプは上部に押印する"},
}
